...
#define GPIO_INIT_SPI1_NSS_PA4  GPIO_INIT_OUTPUT(GPIOA, 4, GPIO_OUTPUT_HIGH_SPEED)
...
#define GPIO_INIT_SPI1_NSS_PB2  GPIO_INIT_OUTPUT(GPIOB, 2, GPIO_OUTPUT_HIGH_SPEED)
...
#define GPIO_INIT_SPI2_NSS_PB12  GPIO_INIT_OUTPUT(GPIOB, 12, GPIO_OUTPUT_HIGH_SPEED)
...
#define GPIO_INIT_SPI2_SCK_PC7  GPIO_INIT_AF(GPIOC, 7, 5, GPIO_OUTPUT_HIGH_SPEED, GPIO_OUTPUT_PUSH_PULL, GPIO_INPUT_PULL_DOWN)
#define GPIO_INIT_SPI2_NSS_PC9  GPIO_INIT_OUTPUT(GPIOC, 9, GPIO_OUTPUT_HIGH_SPEED)
